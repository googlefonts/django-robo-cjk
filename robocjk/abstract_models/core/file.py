...
#             content = File(file)
#             name = name or fsutil.get_filename(path)
#             FileUtilModel.save_file_content(field, name, content, remove_existing)
#         return True
#
#     @staticmethod
...
#         return FileUtilModel.save_file_from_path(path, field, name, remove_existing)
#
#     @staticmethod
...
#         return FileUtilModel.save_file_from_url(url, field, name, remove_existing, content_types)
