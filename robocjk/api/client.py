...
class Client:
    ...
    def _if_int_list(cls, values):
        ls = [value for value in values if isinstance(value, int)] if values else None
        return json.dumps(ls) if ls else None
    ...
    def _if_str_list(cls, values):
        ls = [value for value in values if isinstance(value, str)] if values else None
        return json.dumps(ls) if ls else None
    ...
    def glif_list(
        ...
        font_uid,
        status=None,
        updated_by_current_user=None,
        updated_by=None,
        updated_since=None,
        is_locked_by_current_user=None,
        is_locked_by=None,
        is_locked=None,
        is_empty=None,
        has_variation_axis=None,
        has_outlines=None,
        has_components=None,
        has_unicode=None,
    ):
    ...
    def glif_lock(
        ...
        deep_components=None,
        character_glyphs=None,
        return_data=True,
        return_layers=False,
    ...
    def atomic_element_update_status(
        self,
        font_uid,
        atomic_element_id,
        atomic_element_status,
        ignore_lock=False,
        return_data=True,
        return_layers=False,
        return_related=False,
    ...
    def deep_component_update_status(
        self,
        font_uid,
        deep_component_id,
        deep_component_status,
        ignore_lock=False,
        return_data=True,
        return_layers=False,
        return_related=False,
    ...
    def character_glyph_create(
        self,
        font_uid,
        character_glyph_data,
        return_data=True,
        return_layers=False,
        return_related=False,
    ):
    ...
    def character_glyph_update_status(
        self,
        font_uid,
        character_glyph_id,
        character_glyph_status,
        ignore_lock=False,
        return_data=True,
        return_layers=False,
        return_related=False,
    ...
    def character_glyph_layer_delete(
        self, font_uid, character_glyph_id, layer_id, ignore_lock=False
    ):
        """
