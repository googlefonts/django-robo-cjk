...
from robocjk.api.views import (
    ...
    atomic_element_delete,
    atomic_element_get,
    atomic_element_layer_create,
    atomic_element_layer_delete,
    atomic_element_layer_rename,
    atomic_element_layer_update,
    atomic_element_list,
    atomic_element_lock,
    atomic_element_unlock,
    atomic_element_update,
    auth_refresh_token,
    auth_token,
    character_glyph_create,
    character_glyph_delete,
    character_glyph_get,
    character_glyph_layer_create,
    character_glyph_layer_delete,
    character_glyph_layer_rename,
    character_glyph_layer_update,
    character_glyph_list,
    character_glyph_lock,
    character_glyph_unlock,
    character_glyph_update,
    deep_component_create,
    deep_component_delete,
    deep_component_get,
    deep_component_list,
    deep_component_lock,
    deep_component_unlock,
    deep_component_update,
    font_create,
    font_delete,
    font_get,
    font_list,
    ...
    glif_lock,
    glif_unlock,
    glyphs_composition_get,
    glyphs_composition_update,
    ping,
    project_create,
    project_delete,
    project_get,
...
urlpatterns = [
    ...
    # Gliphs Composition
    path(
        "api/glyphs-composition/get/",
        glyphs_composition_get,
        name="glyphs_composition_get",
    ),
    path(
        "api/glyphs-composition/update/",
        glyphs_composition_update,
        name="glyphs_composition_update",
    ),
    ...
    path(
        ...
        deep_component_create,
        name="deep_component_create",
    ),
    path(
        "api/deep-component/update/",
        deep_component_update,
        name="deep_component_update",
    ),
    path(
        "api/deep-component/delete/",
        deep_component_delete,
        name="deep_component_delete",
    ),
    ...
    path(
        ...
        character_glyph_create,
        name="character_glyph_create",
    ),
    path(
        "api/character-glyph/update/",
        character_glyph_update,
        name="character_glyph_update",
    ),
    path(
    ...
    path(
        ...
        character_glyph_unlock,
        name="character_glyph_unlock",
    ),
    path(
        "api/character-glyph/layer/create/",
        character_glyph_layer_create,
        name="character_glyph_layer_create",
    ),
    path(
        "api/character-glyph/layer/rename/",
        character_glyph_layer_rename,
        name="character_glyph_layer_rename",
    ),
    path(
        "api/character-glyph/layer/update/",
        character_glyph_layer_update,
        name="character_glyph_layer_update",
    ),
    path(
        "api/character-glyph/layer/delete/",
        character_glyph_layer_delete,
        name="character_glyph_layer_delete",
    ),
]
