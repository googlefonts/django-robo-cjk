...
class GitSSHRepositoryURLValidator(RegexValidator):
    ...
    def __init__(self):
        super(GitSSHRepositoryURLValidator, self).__init__(
            regex=GIT_SSH_REPOSITORY_PATTERN,
            message=_('Invalid repository URL - Expected .git repository SSH URL, eg. git@github.com:username/repository.git'))
